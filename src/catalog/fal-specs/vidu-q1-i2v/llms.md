...
- **Endpoint**: `https://fal.run/fal-ai/vidu/q1/image-to-video`
- **Model ID**: `fal-ai/vidu/q1/image-to-video`
...
- **`image_url`** (`string`, _required_):
  ...
  - Examples: "https://storage.googleapis.com/falserverless/model_tests/video_models/vidu_i2v.jpg"
...
```json
{
  ...
  "image_url": "https://storage.googleapis.com/falserverless/model_tests/video_models/vidu_i2v.jpg"
}
```
...
- **`video`** (`File`, _required_):
  ...
  - Examples: {"url":"https://storage.googleapis.com/falserverless/model_tests/video_models/vidu_i2v_output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/vidu/q1/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/vidu/q1/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/vidu/q1/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/vidu/q1/image-to-video)

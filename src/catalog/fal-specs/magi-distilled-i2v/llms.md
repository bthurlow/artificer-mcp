...
- **Endpoint**: `https://fal.run/fal-ai/magi-distilled/image-to-video`
- **Model ID**: `fal-ai/magi-distilled/image-to-video`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Close-up shot: the old sea captain stares intently, pipe in mouth, wisps of smoke curling around his weathered face. The camera begins to pull back out over the ocean. Finally, the camera sinks below the waves deeply, fading to dark blue and finally to black."
...
- **`image_url`** (`string`, _required_):
  ...
  - Examples: "https://raw.githubusercontent.com/painebenjamin/pointy-seeds/refs/heads/main/captain-start.jpg"
...
- **`video`** (`File`, _required_):
  ...
  - Examples: {"url":"https://v3.fal.media/files/zebra/3XmM6yIGZEWxwbbDyTkhw_391bee80-b756-425d-b74c-f9083c7eec4f.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/magi-distilled/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/magi-distilled/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/magi-distilled/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/magi-distilled/image-to-video)

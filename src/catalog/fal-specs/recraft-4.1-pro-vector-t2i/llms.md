...
- **Endpoint**: `https://fal.run/fal-ai/recraft/v4.1/pro/text-to-vector`
- **Model ID**: `fal-ai/recraft/v4.1/pro/text-to-vector`
...
- **`images`** (`list<File>`, _required_)
  - Array of File
  - Examples: [{"file_size":1818794,"content_type":"image/svg+xml","file_name":"image.svg","url":"https://v3b.fal.media/files/b/0a8ee4de/lmXuapOPV309mE533swE0_image.svg"}]
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/recraft/v4.1/pro/text-to-vector \
...
const result = await fal.subscribe("fal-ai/recraft/v4.1/pro/text-to-vector", {
  input: {
    prompt: "a cute character panda with cool clothes, 3d flat color, design"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/recraft/v4.1/pro/text-to-vector)
- [API Documentation](https://fal.ai/models/fal-ai/recraft/v4.1/pro/text-to-vector/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/recraft/v4.1/pro/text-to-vector)

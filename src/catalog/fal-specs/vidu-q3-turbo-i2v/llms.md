...
- **Endpoint**: `https://fal.run/fal-ai/vidu/q3/image-to-video/turbo`
- **Model ID**: `fal-ai/vidu/q3/image-to-video/turbo`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/vidu/q3/image-to-video/turbo \
...
- [Model Playground](https://fal.ai/models/fal-ai/vidu/q3/image-to-video/turbo)
- [API Documentation](https://fal.ai/models/fal-ai/vidu/q3/image-to-video/turbo/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/vidu/q3/image-to-video/turbo)

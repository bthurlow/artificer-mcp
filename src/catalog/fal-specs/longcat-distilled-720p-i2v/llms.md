...
- **Endpoint**: `https://fal.run/fal-ai/longcat-video/distilled/image-to-video/720p`
- **Model ID**: `fal-ai/longcat-video/distilled/image-to-video/720p`
...
Your request will cost **$0.01** per **generated second** of video. Generated seconds are calculated at **30 frames per second.**
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/longcat-video/distilled/image-to-video/720p \
...
- [Model Playground](https://fal.ai/models/fal-ai/longcat-video/distilled/image-to-video/720p)
- [API Documentation](https://fal.ai/models/fal-ai/longcat-video/distilled/image-to-video/720p/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/longcat-video/distilled/image-to-video/720p)

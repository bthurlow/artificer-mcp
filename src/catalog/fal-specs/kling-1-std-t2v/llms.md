...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v1/standard/text-to-video`
- **Model ID**: `fal-ai/kling-video/v1/standard/text-to-video`
...
- **`camera_control`** (`Enum`, _optional_):
  Camera control parameters
  - Options: `"down_back"`, `"forward_up"`, `"right_turn_forward"`, `"left_turn_forward"`

- **`advanced_camera_control`** (`CameraControl`, _optional_):
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v1/standard/text-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v1/standard/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1/standard/text-to-video)

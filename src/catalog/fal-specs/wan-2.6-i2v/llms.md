...
```bash
curl --request POST \
  --url https://fal.run/wan/v2.6/image-to-video \
...
- [Model Playground](https://fal.ai/models/wan/v2.6/image-to-video)
- [API Documentation](https://fal.ai/models/wan/v2.6/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=wan/v2.6/image-to-video)

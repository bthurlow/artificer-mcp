...
- **Endpoint**: `https://fal.run/fal-ai/pixverse/v5.6/text-to-video`
- **Model ID**: `fal-ai/pixverse/v5.6/text-to-video`
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"file_size":5485412,"content_type":"video/mp4","url":"https://storage.googleapis.com/falserverless/model_tests/video_models/output-4.mp4","file_name":"output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/pixverse/v5.6/text-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/pixverse/v5.6/text-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/pixverse/v5.6/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v5.6/text-to-video)

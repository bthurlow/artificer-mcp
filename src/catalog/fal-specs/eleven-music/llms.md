...
- **`audio`** (`File`, _required_):
  ...
  - Examples: {"file_name":"music_generated.mp3","url":"https://storage.googleapis.com/falserverless/example_outputs/elevenlabs/music_generated.mp3","content_type":"audio/mpeg"}

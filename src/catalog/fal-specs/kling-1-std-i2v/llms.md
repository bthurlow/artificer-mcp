...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v1/standard/image-to-video`
- **Model ID**: `fal-ai/kling-video/v1/standard/image-to-video`
...
- **`static_mask_url`** (`string`, _optional_):
  URL of the image for Static Brush Application Area (Mask image created by users using the motion brush)
  - Examples: "https://storage.googleapis.com/falserverless/kling/new_static_mask.png"

- **`dynamic_masks`** (`list<DynamicMask>`, _optional_):
  List of dynamic masks
  - Array of DynamicMask
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v1/standard/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v1/standard/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1/standard/image-to-video)

...
- **Endpoint**: `https://fal.run/fal-ai/minimax/speech-2.8-turbo`
- **Model ID**: `fal-ai/minimax/speech-2.8-turbo`
...
- **Price**: $0.06 per 1000 characters
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Hello world! Welcome to MiniMax's new text to speech model <#0.1#> Speech 2.8 Turbo (sighs) now available on Fal!"
...
```json
{
  "prompt": "Hello world! Welcome to MiniMax's new text to speech model <#0.1#> Speech 2.8 Turbo (sighs) now available on Fal!"
}
```
...
- **`audio`** (`File`, _required_):
  ...
  - Examples: {"url":"https://v3b.fal.media/files/b/0a8d0bf6/AE2KhEIGf4SkSMrWIDs45_speech.mp3"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/minimax/speech-2.8-turbo \
...
- [Model Playground](https://fal.ai/models/fal-ai/minimax/speech-2.8-turbo)
- [API Documentation](https://fal.ai/models/fal-ai/minimax/speech-2.8-turbo/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/minimax/speech-2.8-turbo)

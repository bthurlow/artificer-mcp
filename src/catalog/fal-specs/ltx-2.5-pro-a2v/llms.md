...
- **Endpoint**: `https://fal.run/lightricks/ltx-2.5/audio-to-video/pro`
- **Model ID**: `lightricks/ltx-2.5/audio-to-video/pro`
...
Billing is calculated per second of the input audio. At **1080p**, your request will cost **$0.17** per second. Native audio is included. For **$1** you can run this model for approximately **6 seconds** of input audio at **1080p**.
...
```bash
curl --request POST \
  --url https://fal.run/lightricks/ltx-2.5/audio-to-video/pro \
...
const result = await fal.subscribe("lightricks/ltx-2.5/audio-to-video/pro", {
  input: {
    audio_url: "https://v3b.fal.media/files/b/0a90dfe7/3a-DUXzO79XWIYwUDfHZX_output.mp3"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/lightricks/ltx-2.5/audio-to-video/pro)
- [API Documentation](https://fal.ai/models/lightricks/ltx-2.5/audio-to-video/pro/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=lightricks/ltx-2.5/audio-to-video/pro)

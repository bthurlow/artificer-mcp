...
- **Endpoint**: `https://fal.run/fal-ai/ltxv-13b-098-distilled/image-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltxv-13b-098-distilled/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltxv-13b-098-distilled/image-to-video)

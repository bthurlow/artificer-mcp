...
The pricing is $0.30/s for 720p, $0.50/s for legacy 1080p (1792x1024 or 1024x1792) or $0.70/s for true 1080p (1920x1080 or 1080x1920).
...
- **`resolution`** (`ResolutionEnum`, _optional_):
  ...
  - Default: `"auto"`
  - Options: `"auto"`, `"720p"`, `"1080p"`, `"true_1080p"`
...
- **`video`** (`VideoFile`, _required_):
  The generated video
  - Examples: {"url":"https://storage.googleapis.com/falserverless/example_outputs/sora-2-pro-i2v-output.mp4","content_type":"video/mp4"}

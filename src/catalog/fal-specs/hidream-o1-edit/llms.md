...
- **Endpoint**: `https://fal.run/fal-ai/hidream-o1-image/edit`
- **Model ID**: `fal-ai/hidream-o1-image/edit`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "A cinematic product photo of a ceramic mug on a marble counter, soft window light, shallow depth of field."
...
- **`image_size`** (`ImageSize | Enum`, _optional_):
  Requested output image size. Reference-image outputs use the nearest model-supported resolution up to about 2048x2048 pixels.
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/hidream-o1-image/edit \
...
- [Model Playground](https://fal.ai/models/fal-ai/hidream-o1-image/edit)
- [API Documentation](https://fal.ai/models/fal-ai/hidream-o1-image/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hidream-o1-image/edit)

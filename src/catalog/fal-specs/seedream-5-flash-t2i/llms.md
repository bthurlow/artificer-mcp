...
- **Endpoint**: `https://fal.run/bytedance/seedream/v5/flash/text-to-image`
- **Model ID**: `bytedance/seedream/v5/flash/text-to-image`
...
```bash
curl --request POST \
  --url https://fal.run/bytedance/seedream/v5/flash/text-to-image \
...
const result = await fal.subscribe("bytedance/seedream/v5/flash/text-to-image", {
  input: {
    prompt: "Vibrant editorial of a model in contemporary fashion fused with West African textile patterns and beadwork, Campbell Addy bold aesthetic, saturated palette, dramatic studio lighting, celebratory cultural richness, striking contemporary portraiture"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/bytedance/seedream/v5/flash/text-to-image)
- [API Documentation](https://fal.ai/models/bytedance/seedream/v5/flash/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=bytedance/seedream/v5/flash/text-to-image)

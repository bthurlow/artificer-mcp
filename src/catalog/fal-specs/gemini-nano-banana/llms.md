...
- **`images`** (`list<ImageFile>`, _required_):
  ...
  - Array of ImageFile
  - Examples: [{"content_type":"image/png","url":"https://storage.googleapis.com/falserverless/example_outputs/nano-banana-2-t2i-output.png","file_name":"nano-banana-2-t2i-output.png"}]
...
- [Model Playground](https://fal.ai/models/fal-ai/nano-banana-2)

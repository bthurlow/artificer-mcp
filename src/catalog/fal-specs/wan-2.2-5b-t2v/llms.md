...
- **Endpoint**: `https://fal.run/fal-ai/wan/v2.2-5b/text-to-video`
- **Model ID**: `fal-ai/wan/v2.2-5b/text-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan/v2.2-5b/text-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan/v2.2-5b/text-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/wan/v2.2-5b/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-5b/text-to-video)

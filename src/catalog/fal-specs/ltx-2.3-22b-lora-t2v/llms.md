...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-22b/text-to-video/lora`
- **Model ID**: `fal-ai/ltx-2.3-22b/text-to-video/lora`
...
- **`video`** (`VideoFile`, _required_):
  The generated video.
  - Examples: {"duration":6.44,"num_frames":161,"url":"https://v3b.fal.media/files/b/0a8824b1/sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4","content_type":"video/mp4","fps":25,"height":704,"width":1248,"file_name":"sdm0KfmenrlywesfzY1Y1_if6euPp1.mp4"}
...
const result = await fal.subscribe("fal-ai/ltx-2.3-22b/text-to-video/lora", {
  input: {
    prompt: "A cowboy walking through a dusty town at high noon, camera following from behind, cinematic depth, realistic lighting, western mood, 4K film grain.",
    loras: [{
      path: "",
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-22b/text-to-video/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-22b/text-to-video/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-22b/text-to-video/lora)

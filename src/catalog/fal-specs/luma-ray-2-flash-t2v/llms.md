...
- **Endpoint**: `https://fal.run/fal-ai/luma-dream-machine/ray-2-flash`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/luma-dream-machine/ray-2-flash \
...
- [Model Playground](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2-flash)
- [API Documentation](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2-flash/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-dream-machine/ray-2-flash)

...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/minimax/video-01/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/minimax/video-01/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/minimax/video-01/image-to-video/api)

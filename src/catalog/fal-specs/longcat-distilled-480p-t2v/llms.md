...
- **Endpoint**: `https://fal.run/fal-ai/longcat-video/distilled/text-to-video/480p`
- **Model ID**: `fal-ai/longcat-video/distilled/text-to-video/480p`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/longcat-video/distilled/text-to-video/480p \
...
- [Model Playground](https://fal.ai/models/fal-ai/longcat-video/distilled/text-to-video/480p)
- [API Documentation](https://fal.ai/models/fal-ai/longcat-video/distilled/text-to-video/480p/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/longcat-video/distilled/text-to-video/480p)

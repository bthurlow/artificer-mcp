...
- **Endpoint**: `https://fal.run/fal-ai/longcat-video/distilled/text-to-video/720p`
- **Model ID**: `fal-ai/longcat-video/distilled/text-to-video/720p`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/longcat-video/distilled/text-to-video/720p \
...
- [Model Playground](https://fal.ai/models/fal-ai/longcat-video/distilled/text-to-video/720p)
- [API Documentation](https://fal.ai/models/fal-ai/longcat-video/distilled/text-to-video/720p/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/longcat-video/distilled/text-to-video/720p)

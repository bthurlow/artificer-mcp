...
- **Endpoint**: `https://fal.run/fal-ai/ltx-video-13b-distilled/image-to-video`
- **Model ID**: `fal-ai/ltx-video-13b-distilled/image-to-video`
...
Your request will cost **$0.04** per second of generated video (at 24 fps), and **$0.08** per second if the detail pass is enabled.
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-video-13b-distilled/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video-13b-distilled/image-to-video)

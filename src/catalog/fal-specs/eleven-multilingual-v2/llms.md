...
- **Endpoint**: `https://fal.run/fal-ai/elevenlabs/tts/multilingual-v2`
- **Model ID**: `fal-ai/elevenlabs/tts/multilingual-v2`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/elevenlabs/tts/multilingual-v2 \
...
- [Model Playground](https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2)
- [API Documentation](https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/elevenlabs/tts/multilingual-v2)

...
- **`prompt`** (`string`, _required_)
  - Examples: "Snowflakes fall as a car moves along the road."
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v1.5/pro/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v1.5/pro/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1.5/pro/image-to-video)

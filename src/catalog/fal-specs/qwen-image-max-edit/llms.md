...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Change wolves with extremely realistic small puppies of different colors."
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/qwen-image-max/edit \
...
- [Model Playground](https://fal.ai/models/fal-ai/qwen-image-max/edit)
- [API Documentation](https://fal.ai/models/fal-ai/qwen-image-max/edit/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-max/edit)

...
- **Endpoint**: `https://fal.run/alibaba/wan-3.0/reference-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/alibaba/wan-3.0/reference-to-video \
...
const result = await fal.subscribe("alibaba/wan-3.0/reference-to-video", {
  input: {},
  logs: true,
...
- [Model Playground](https://fal.ai/models/alibaba/wan-3.0/reference-to-video)
- [API Documentation](https://fal.ai/models/alibaba/wan-3.0/reference-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=alibaba/wan-3.0/reference-to-video)

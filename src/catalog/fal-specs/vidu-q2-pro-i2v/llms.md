...
- **Endpoint**: `https://fal.run/fal-ai/vidu/q2/image-to-video/pro`
- **Model ID**: `fal-ai/vidu/q2/image-to-video/pro`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/vidu/q2/image-to-video/pro \
...
- [Model Playground](https://fal.ai/models/fal-ai/vidu/q2/image-to-video/pro)
- [API Documentation](https://fal.ai/models/fal-ai/vidu/q2/image-to-video/pro/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/vidu/q2/image-to-video/pro)

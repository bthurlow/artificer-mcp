...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/o3/standard/text-to-video`
- **Model ID**: `fal-ai/kling-video/o3/standard/text-to-video`
...
- **`video`** (`File`, _required_):
  The generated video.
  - Examples: {"file_name":"output.mp4","url":"https://v3b.fal.media/files/b/0a8d04e2/idOb9V-Q9ujlggPSKqsfS_output.mp4","content_type":"video/mp4","file_size":13096952}
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/o3/standard/text-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/o3/standard/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/o3/standard/text-to-video)

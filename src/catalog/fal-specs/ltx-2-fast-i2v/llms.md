...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2/image-to-video/fast`
- **Model ID**: `fal-ai/ltx-2/image-to-video/fast`
...
- **`video`** (`VideoFile`, _required_):
  ...
  - Examples: {"content_type":"video/mp4","url":"https://storage.googleapis.com/falserverless/example_outputs/ltxv-2-i2v-output.mp4","file_name":"ltxv-2-i2v-output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2/image-to-video/fast \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2/image-to-video/fast)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2/image-to-video/fast/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2/image-to-video/fast)

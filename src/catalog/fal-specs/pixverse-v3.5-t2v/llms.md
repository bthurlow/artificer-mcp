...
- **Endpoint**: `https://fal.run/fal-ai/pixverse/v3.5/text-to-video`
- **Model ID**: `fal-ai/pixverse/v3.5/text-to-video`
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"file_name":"output.mp4","url":"https://fal.media/files/zebra/11UahivZ3XZ1tRlcEcgPq_output.mp4","file_size":2995630,"content_type":"video/mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/pixverse/v3.5/text-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/pixverse/v3.5/text-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/pixverse/v3.5/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v3.5/text-to-video)

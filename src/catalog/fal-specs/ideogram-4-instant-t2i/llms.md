...
- **Endpoint**: `https://fal.run/ideogram/v4/instant`
- **Model ID**: `ideogram/v4/instant`
...
```bash
curl --request POST \
  --url https://fal.run/ideogram/v4/instant \
...
const result = await fal.subscribe("ideogram/v4/instant", {
  input: {
    prompt: "A red panda perched on a mossy branch in a misty forest at sunrise"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/ideogram/v4/instant)
- [API Documentation](https://fal.ai/models/ideogram/v4/instant/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=ideogram/v4/instant)

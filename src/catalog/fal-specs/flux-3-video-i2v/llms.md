...
- **Endpoint**: `https://fal.run/blackforestlabs/flux-3/image-to-video`
- **Model ID**: `blackforestlabs/flux-3/image-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/blackforestlabs/flux-3/image-to-video \
...
const result = await fal.subscribe("blackforestlabs/flux-3/image-to-video", {
  input: {
    prompt: "A red panda walks along a mossy log in a sunlit forest, one continuous unbroken shot. Ambient birdsong and rustling leaves.",
    image_url: "https://storage.googleapis.com/falserverless/example_inputs/veo31_i2v_input.jpg"
  },
...
- [Model Playground](https://fal.ai/models/blackforestlabs/flux-3/image-to-video)
- [API Documentation](https://fal.ai/models/blackforestlabs/flux-3/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=blackforestlabs/flux-3/image-to-video)

...
- **Endpoint**: `https://fal.run/alibaba/happy-horse/v1.1/text-to-video`
- **Model ID**: `alibaba/happy-horse/v1.1/text-to-video`
- **Category**: text-to-video
- **Kind**: inference
**Tags**: happy-horse, video, text
...
```bash
curl --request POST \
  --url https://fal.run/alibaba/happy-horse/v1.1/text-to-video \
...
const result = await fal.subscribe("alibaba/happy-horse/v1.1/text-to-video", {
  input: {
    prompt: "A little girl walking on the road at sunset, cinematic lighting, smooth camera movement."
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/alibaba/happy-horse/v1.1/text-to-video)
- [API Documentation](https://fal.ai/models/alibaba/happy-horse/v1.1/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=alibaba/happy-horse/v1.1/text-to-video)

...
- **`use_dmd`** (`boolean`, _optional_):
  Enable the upstream DMD distillation LoRA and 4-step scheduler. The slower non-DMD scheduler is currently disabled for this endpoint because it can exceed serverless request limits. Default value: `true`
  - Default: `true`

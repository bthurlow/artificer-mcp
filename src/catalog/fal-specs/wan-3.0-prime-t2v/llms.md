...
- **Endpoint**: `https://fal.run/alibaba/wan-3.0-prime/text-to-video`
- **Model ID**: `alibaba/wan-3.0-prime/text-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/alibaba/wan-3.0-prime/text-to-video \
...
const result = await fal.subscribe("alibaba/wan-3.0-prime/text-to-video", {
  input: {
    prompt: "A red panda walking through a bamboo forest at sunrise"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/alibaba/wan-3.0-prime/text-to-video)
- [API Documentation](https://fal.ai/models/alibaba/wan-3.0-prime/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=alibaba/wan-3.0-prime/text-to-video)

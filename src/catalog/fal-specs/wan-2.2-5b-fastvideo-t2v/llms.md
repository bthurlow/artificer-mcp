...
Your request will cost **$0.025** per **video** for **720p**, **$0.01875** per **video** for **580p**, **$0.0125** per **video** for **480p**.
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan/v2.2-5b/text-to-video/fast-wan \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan/v2.2-5b/text-to-video/fast-wan)
- [API Documentation](https://fal.ai/models/fal-ai/wan/v2.2-5b/text-to-video/fast-wan/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-5b/text-to-video/fast-wan)

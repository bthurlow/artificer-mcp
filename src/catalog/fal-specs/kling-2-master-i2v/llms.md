...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/v2/master/image-to-video`
...
- **`prompt`** (`string`, _required_)
  - Examples: "slow-motion sequence captures the catastrophic implosion of a skyscraper, dust and debris billowing outwards in a chaotic ballet of destruction, while a haunting, orchestral score underscores the sheer power and finality of the event."

- **`image_url`** (`string`, _required_):
  URL of the image to be used for the video
  - Examples: "https://v3.fal.media/files/elephant/rkH-9qoXtXu3rAYTsx9V5_image.webp"
...
- **`video`** (`File`, _required_):
  The generated video
  - Examples: {"url":"https://v3.fal.media/files/koala/VvGXP5xEhTR9ovGjpulJ7_output.mp4"}
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/v2/master/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/v2/master/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v2/master/image-to-video)

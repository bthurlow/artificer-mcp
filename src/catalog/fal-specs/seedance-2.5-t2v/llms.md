...
- **Endpoint**: `https://fal.run/bytedance/seedance-2.5/text-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/bytedance/seedance-2.5/text-to-video \
...
- [Model Playground](https://fal.ai/models/bytedance/seedance-2.5/text-to-video)
- [API Documentation](https://fal.ai/models/bytedance/seedance-2.5/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=bytedance/seedance-2.5/text-to-video)

...
- **Endpoint**: `https://fal.run/fal-ai/vidu/q1/start-end-to-video`
- **Model ID**: `fal-ai/vidu/q1/start-end-to-video`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "Dragon lands on a rock"

- **`start_image_url`** (`string`, _required_):
  URL of the image to use as the first frame
  - Examples: "https://v3.fal.media/files/zebra/sgsdKvPigPhJ1S7Hl5bWc_first_frame_q1.png"

- **`end_image_url`** (`string`, _required_):
  URL of the image to use as the last frame
  - Examples: "https://v3.fal.media/files/kangaroo/CASBu_OmOnZ8IafirarFL_last_frame_q1.png"
...
- **`video`** (`File`, _required_):
  ...
  - Examples: {"url":"https://fal.media/files/zebra/-ACpJE6m4JQSBCCeNB51S_output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/vidu/q1/start-end-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/vidu/q1/start-end-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/vidu/q1/start-end-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/vidu/q1/start-end-to-video)

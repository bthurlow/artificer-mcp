...
- **Endpoint**: `https://fal.run/fal-ai/wan/v2.2-5b/image-to-video`
- **Model ID**: `fal-ai/wan/v2.2-5b/image-to-video`
...
- **`video`** (`File`, _required_):
  ...
  - Examples: {"url":"https://storage.googleapis.com/falserverless/model_tests/wan/v2.2-small-i2v-output.mp4"}
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/wan/v2.2-5b/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/wan/v2.2-5b/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/wan/v2.2-5b/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-5b/image-to-video)

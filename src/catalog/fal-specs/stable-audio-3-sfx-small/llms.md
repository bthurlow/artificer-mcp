...
- **Endpoint**: `https://fal.run/fal-ai/stable-audio-3/small/sfx/text-to-audio`
- **Model ID**: `fal-ai/stable-audio-3/small/sfx/text-to-audio`
- **Category**: text-to-audio
- **Kind**: inference
**Tags**: sfx, sound-effects, on-device



## Pricing

- **Price**: $0.0206 per audios
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/stable-audio-3/small/sfx/text-to-audio \
...
const result = await fal.subscribe("fal-ai/stable-audio-3/small/sfx/text-to-audio", {
  input: {
    prompt: "An anthemic Pop Rock instrumental that fills your head with nostalgic thoughtfulness"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/stable-audio-3/small/sfx/text-to-audio)
- [API Documentation](https://fal.ai/models/fal-ai/stable-audio-3/small/sfx/text-to-audio/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/stable-audio-3/small/sfx/text-to-audio)

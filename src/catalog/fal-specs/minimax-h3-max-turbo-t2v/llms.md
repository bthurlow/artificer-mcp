...
- **Endpoint**: `https://fal.run/minimax/h3-max-turbo/text-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/minimax/h3-max-turbo/text-to-video \
...
- [Model Playground](https://fal.ai/models/minimax/h3-max-turbo/text-to-video)
- [API Documentation](https://fal.ai/models/minimax/h3-max-turbo/text-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=minimax/h3-max-turbo/text-to-video)

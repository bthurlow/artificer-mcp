...
- **Endpoint**: `https://fal.run/krea/v2/large/text-to-image`
...
For every image you generate, you will be charged **$0.060** (text-to-image) or **$0.065** (using image_style_references).
...
const result = await fal.subscribe("krea/v2/large/text-to-image", {
  input: {
    prompt: "A Van Gogh-tinged Provençal farmhouse under starry nights."
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/krea/v2/large/text-to-image)
- [API Documentation](https://fal.ai/models/krea/v2/large/text-to-image/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=krea/v2/large/text-to-image)

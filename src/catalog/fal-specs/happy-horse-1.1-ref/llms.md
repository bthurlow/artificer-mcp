...
- **Endpoint**: `https://fal.run/alibaba/happy-horse/v1.1/reference-to-video`
- **Model ID**: `alibaba/happy-horse/v1.1/reference-to-video`
- **Category**: image-to-video
- **Kind**: inference
**Tags**: happy-horse, video, reference



## Pricing

For every second of 720p video you generated, you will be charged **$0.14/second**.  For 1080p video you will be charged **$0.18/second**. 
...
```bash
curl --request POST \
  --url https://fal.run/alibaba/happy-horse/v1.1/reference-to-video \
...
const result = await fal.subscribe("alibaba/happy-horse/v1.1/reference-to-video", {
  input: {
    prompt: "A dance battle between character1 and character2, cinematic lighting, smooth camera movement.",
    image_urls: ["https://help-static-aliyun-doc.aliyuncs.com/file-manage-files/zh-CN/20250925/wpimhv/rap.png"]
  },
...
- [Model Playground](https://fal.ai/models/alibaba/happy-horse/v1.1/reference-to-video)
- [API Documentation](https://fal.ai/models/alibaba/happy-horse/v1.1/reference-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=alibaba/happy-horse/v1.1/reference-to-video)

...
- **Endpoint**: `https://fal.run/fal-ai/ltx-video-13b-distilled`
- **Model ID**: `fal-ai/ltx-video-13b-distilled`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-video-13b-distilled \
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-video-13b-distilled)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-video-13b-distilled/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video-13b-distilled)

...
- **Endpoint**: `https://fal.run/fal-ai/speech-to-text`
- **Model ID**: `fal-ai/speech-to-text`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/speech-to-text \
...
- [Model Playground](https://fal.ai/models/fal-ai/speech-to-text)
- [API Documentation](https://fal.ai/models/fal-ai/speech-to-text/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/speech-to-text)

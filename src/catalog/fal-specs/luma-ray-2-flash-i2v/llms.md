...
- **Endpoint**: `https://fal.run/fal-ai/luma-dream-machine/ray-2-flash/image-to-video`
- **Model ID**: `fal-ai/luma-dream-machine/ray-2-flash/image-to-video`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/luma-dream-machine/ray-2-flash/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2-flash/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/luma-dream-machine/ray-2-flash/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-dream-machine/ray-2-flash/image-to-video)

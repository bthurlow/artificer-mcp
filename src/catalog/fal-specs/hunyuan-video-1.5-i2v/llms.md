...
- **Endpoint**: `https://fal.run/fal-ai/hunyuan-video-v1.5/image-to-video`
- **Model ID**: `fal-ai/hunyuan-video-v1.5/image-to-video`
...
- **`prompt`** (`string`, _required_):
  ...
  - Examples: "A stark starting line divides two powerful cars, engines revving for the challenge ahead. They surge forward in the heat of competition, a blur of speed and chrome. The finish line looms as they race for victory."
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/hunyuan-video-v1.5/image-to-video \
...
- [Model Playground](https://fal.ai/models/fal-ai/hunyuan-video-v1.5/image-to-video)
- [API Documentation](https://fal.ai/models/fal-ai/hunyuan-video-v1.5/image-to-video/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hunyuan-video-v1.5/image-to-video)
